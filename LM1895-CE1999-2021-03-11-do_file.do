...
********************************************************************************
******************** CODGIO PARA CENSO ECONOMICO 1999 **************************
********************************************************************************
...
keep e03 e04 clase popto emact pnrt torst sa su pagsub pcys afts ///
cpss vacb abmi percom g111a

*RENOMBRANDO VARIABLES
rename e03 estado
rename e04 muni
rename clase scian_6
rename popto azul
rename emact blanco
rename pnrt familia
rename torst outsour
rename percom no_asa
rename sa s_azul
rename su s_blanco
rename pagsub g_outsour
rename pcys g_no_asa
rename afts act_fijos
rename cpss g_seg_social
rename vacb v_agregado
rename abmi g_cap_rent
...
gen a_s=0.416722237
replace a_s=0.487260858 if scian_2=="43"
replace a_s=0.421425974 if scian_2=="46"
replace a_s=0.563962451 if scian_2=="51"
replace a_s=0.936855281 if scian_2=="53"
replace a_s=0.324035935 if scian_2=="54"
replace a_s=0.147975358 if scian_2=="55"
replace a_s=0.233143656 if scian_2=="56"
replace a_s=0.194963912 if scian_2=="61"
replace a_s=0.185894864 if scian_2=="62"
replace a_s=0.446774096 if scian_2=="71"
replace a_s=0.373817127 if scian_2=="72"
replace a_s=0.384807745 if scian_2=="81"
...
replace a_s=0.256496929 if scian_3=="321"
replace a_s=0.427805392 if scian_3=="327"
replace a_s=0.320519629 if scian_3=="331"
replace a_s=0.33513891 if scian_3=="332"
replace a_s=0.341298998 if scian_3=="333"
replace a_s=0.382506024 if scian_3=="334"
replace a_s=0.307180359 if scian_3=="335"
replace a_s=0.423331261 if scian_3=="336"
replace a_s=0.283055134 if scian_3=="337"
replace a_s=0.383248915 if scian_3=="339"
replace a_s=0.524095224 if scian_3=="312"
replace a_s=0.261883568 if scian_3=="313"
replace a_s=0.240524159 if scian_3=="316"
replace a_s=0.429024115 if scian_3=="322"
replace a_s=0.157893411 if scian_3=="323"
replace a_s=0.787373294 if scian_3=="324"
replace a_s=0.629686118 if scian_3=="325"
replace a_s=0.404566062 if scian_3=="326"
replace a_s=0.437290328 if scian_3=="468"
replace a_s=0.369970679 if scian_3=="461"
replace a_s=0.434823986 if scian_3=="511"
replace a_s=0.607444939 if scian_3=="512"
replace a_s=0.646957881 if scian_3=="515"
replace a_s=0.333099363 if scian_3=="518"
replace a_s=0.951191287 if scian_3=="531"
replace a_s=0.81517372 if scian_3=="533"
replace a_s=0.213191512 if scian_3=="561"
replace a_s=0.416857495 if scian_3=="562"
replace a_s=0.237241859 if scian_3=="621"
replace a_s=0.143890253 if scian_3=="622"
replace a_s=0.080726737 if scian_3=="623"
replace a_s=0.195639035 if scian_3=="624"
replace a_s=0.469444034 if scian_3=="711"
replace a_s=0.469444034 if scian_3=="712"
replace a_s=0.424972177 if scian_3=="713"
replace a_s=0.447170908 if scian_3=="721"
replace a_s=0.339874915 if scian_3=="722"
...
*GUARDANDO BASE
save variables_muni_99, replace
